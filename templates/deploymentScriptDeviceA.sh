...
BIGIP_HOST_SUBNET_WITH_MASK=$(oc get hostsubnet f5-bigip-float -o json | jq .subnet -r)
...
curl -s -k -X PATCH -H "Content-Type: application/json" -u admin:$BIGIP_MGMT_PASSWORD https://$BIGIP_MGMT_ADDRESS/mgmt/tm/net/self/tunnelSelfIP -d '{"allowService": ["default","tcp:4789"]}'
